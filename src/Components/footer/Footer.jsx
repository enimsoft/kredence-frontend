    ...
    return(
        <div className={styles.footer}>
            ...
            <div className={styles.footerblock}>
                ...
                <p className={styles.footertext}>Trump Card</p>
            </div>
            ...
            <div className={styles.footerblock}>
                ...
                <img src= {require("../../assets/logo512.png")} className={styles.enimlogo} alt=""/>
                <p className={styles.footertext}>Enim AI</p>
                <p className={styles.footertext}>© Kredence Materials</p> 
