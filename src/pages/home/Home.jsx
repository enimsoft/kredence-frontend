...
<>
    ...
    <div className={styles.products}>
      <div>
        <a as={Link} to="/products/honeywell">
          <img className={styles.pimage} src={require("../../assets/products/honeywell/honeywell.png")} alt="" />
        </a>
      </div>
      ...
      <div>
        <a>
          <img className={styles.pimage} src={require("../../assets/products/elementum/elment.png")} alt="" />
        </a>
      </div>

      <div>
        <a>
          <img className={styles.pimage} src={require("../../assets/products/altapure/alta.png")} alt="" />
        </a>
      </div>
    </div>
  </div>
  ...
  <div className={styles.exp}>
    <div className={styles.headings} style={{ padding: "0px", marginTop:'0px' }}>
      <h2 style={{ color: "#707070" }}>Our Experience</h2>
      <hr style={{ backgroundColor: "#707070" }} />
    </div>

    <div className={styles.expcard}>
      <img className={styles.eimage} src={require("../../assets/p1.jpeg")} alt="" />
      <p>
