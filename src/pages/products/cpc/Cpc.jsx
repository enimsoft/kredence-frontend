      ...
      <div className={styles.imageconatiner}>
        <div className={styles.imagecard1}>
          <img
            ...
            alt=""
            src={require("../../../assets/products/cpc/drumpquickpro.jpg")}
          />
        ...
        <div className={styles.imagecard2}>
          <img
            className={styles.image}
            alt=""
            src={require("../../../assets/products/cpc/collage.png")}
          />
        ...
        <div className={styles.imagecard1}>
          <img
            className={styles.image}
            alt=""
            src={require("../../../assets/products/cpc/collag1.jpg")}
          />
          <p className={styles.imagetext1}>{"DrumQuik® PRO/PUR"}</p>
        </div>
        ...
        <div className={styles.imagecard2}>
          <img
            className={styles.image}
            alt=""
            src={require("../../../assets/products/cpc/collag2.png")}
          />
          <p className={styles.imagetext2}>{"Easy to use"}</p>
        </div>
      </div>
