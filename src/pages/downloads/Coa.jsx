...
<div>
  ...
  <div className={styles.dimage}>
      <img src={require("../../assets/downloads/coa.jpeg")} className={styles.image} alt="" />
    </div>
    <div>
      <input type="text" placeholder="Product Number" className={styles.textfield} /><br />
      <input type="text" placeholder="Batch Number" className={styles.textfield} />
      <br />
  ...
  <div className={styles.other}>
    <div>
      <a href="https://lab.honeywell.com/en/coa"><img className={styles.logos} href="https://www.google.com"
          src={require("../../assets/products/honeywell/honeywell.png")} alt="" /></a>
